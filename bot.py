...
WITHDRAW = {
		...
		"INFO"     : ("Withdraws specified amount to specified address, " +
				...
				"\nExample: `withdraw ban_133711111111111111111111111111111111111111111111111hifc8npp 1000` - Withdraws 1000 BANANO")
}
...
RAIN = {
		...
		"INFO"     : ("Distribute <amount> evenly to users who are eligible.\n" +
				...
				"\n**Minimum rain amount: {0} BANANO**").format(RAIN_MINIMUM)
}
...
START_GIVEAWAY = {
		...
		"INFO"     : ("Start a giveaway with given amount, entry fee, and duration." +
				...
				"\n**Minimum required to sponsor a giveaway: {0} BANANO**" +
